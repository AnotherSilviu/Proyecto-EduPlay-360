function mostrarFunciones(nombre) {
    const funciones = {
      "Ramón García": "<h3>Ramón García</h3><p><strong>Funciones Clave:</strong> Supervisión de la estrategia global, alineación con socios y gestión del presupuesto.</p><p><strong>Fases ADDIE:</strong> TODAS (Análisis y Evaluación en especial)</p>",
      "Raquel Enriquez": "<h3>Raquel Enriquez</h3><p><strong>Funciones Clave:</strong>Gestión pedagógica, supervisión de la calidad educativa y del cumplimiento de los objetivos de la formación.</p><p><strong>Fases ADDIE:</strong>Diseño, Desarrollo, Implementación</p>",
